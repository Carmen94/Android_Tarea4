...
public class ActivityProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storeEditText.setText(itemProduct.getStore());
        locationEditText.setText(itemProduct.getLocation());
        phoneEditText.setText(itemProduct.getPhone());
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                itemProduct.setStore(storeEditText.getText().toString());
                itemProduct.setLocation(locationEditText.getText().toString());
                itemProduct.setPhone(phoneEditText.getText().toString());
